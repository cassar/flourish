...
# Pinned >= 4.3.0: older Manifest#compile_legacy_manifest passed a
# create_additions keyword to JSON.parse that json 3.0+ dropped.
gem 'sprockets', '>= 4.3.0'
gem 'sprockets-rails'
...
# Use CSS bundling with Tailwind [https://github.com/rails/cssbundling-rails]
